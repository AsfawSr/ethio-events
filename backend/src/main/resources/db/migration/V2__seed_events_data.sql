...
VALUES 
    ('b1111111-1111-1111-1111-111111111111', 'e1111111-1111-1111-1111-111111111111', 'Early Bird General', 'Standing area access with standard stage view', 800.00, 5000, 4820, 0, 5, '2026-09-01 00:00:00+00', '2026-10-10 12:00:00+00'),
    ('b2222222-2222-2222-2222-222222222222', 'e1111111-1111-1111-1111-111111111111', 'VIP Front Stage', 'Front circle priority access + fast-track gate entry', 2500.00, 1500, 1420, 0, 4, '2026-09-01 00:00:00+00', '2026-10-10 12:00:00+00'),
    ('b3333333-3333-3333-3333-333333333333', 'e1111111-1111-1111-1111-111111111111', 'VVIP Lounge & Drinks', 'Elevated lounge with free welcome drinks & artist backstage meetup', 6000.00, 200, 185, 0, 2, '2026-09-01 00:00:00+00', '2026-10-10 12:00:00+00'),

-- Tickets for Tech Summit
    ('b4444444-4444-4444-4444-444444444444', 'e2222222-2222-2222-2222-222222222222', 'Standard Pass (2 Days)', 'Full access to keynotes, exhibitions, and networking lounges', 1500.00, 1000, 950, 0, 5, '2026-09-01 00:00:00+00', '2026-11-05 05:00:00+00'),
    ('b5555555-5555-5555-5555-555555555555', 'e2222222-2222-2222-2222-222222222222', 'Executive VIP & Gala Dinner', 'Includes Executive VIP Lounge + Gala Dinner at Ethiopian Skylight Hotel', 5000.00, 300, 280, 0, 2, '2026-09-01 00:00:00+00', '2026-11-05 05:00:00+00'),

-- Tickets for Comedy Night
    ('b6666666-6666-6666-6666-666666666666', 'e3333333-3333-3333-3333-333333333333', 'Regular Seat', 'Table seating in garden amphitheater', 500.00, 400, 360, 0, 6, '2026-09-01 00:00:00+00', '2026-09-25 14:00:00+00')
ON CONFLICT (id) DO NOTHING;
